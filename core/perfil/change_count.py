...
from core.perfil.profile_memory import (
    get_active_profiles,
    mark_profile_expired,
)
from core.utils.logger import log_info, log_warn  # noqa: E402
...
OPEN_PROFILE_JS = PROJECT_ROOT / "core" / "perfil" / "abrir_perfil_dicloak.js"

if IS_WINDOWS:
    FORCE_CDP_SCRIPT = PROJECT_ROOT / "scripts" / "legacy" / "forzar_cdp_perfil_dicloak.ps1"
    PS_EXE = Path(os.environ.get("SystemRoot", r"C:\Windows")) / "System32" / "WindowsPowerShell" / "v1.0" / "powershell.exe"
else:
    FORCE_CDP_SCRIPT = PROJECT_ROOT / "scripts" / "mac" / "cdp" / "forzar_cdp_perfil.sh"
    PS_EXE = None
